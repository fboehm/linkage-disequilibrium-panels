...
% Bottom of the main column: evidence figures (side by side) + caption below
\begin{center}
...
\textbf{Infinitesimal traits}
all six panel ancestries have simlar PGS accuracies; panel size has
negligible effect.
\\[0.6em]
